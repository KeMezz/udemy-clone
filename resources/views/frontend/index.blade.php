                    ...
                    <div class="hero-content text-right">
                        ...
                        <div class="hero-btn-box d-flex flex-wrap align-items-center pt-1 justify-content-end">
                            ...
                            <a href="admission.html" class="btn theme-btn mb-4"><i
                                    class="la la-arrow-left icon mr-1"></i>Get
                                Enrolled </a>
                        </div><!-- end hero-btn-box -->
                    </div><!-- end hero-content -->
                </div><!-- container -->
            ...
            <div class="row feature-content-wrap">
                <div class="col-lg-4 responsive-column-half">
                    <div class="info-box">
                        ...
                        <p class="info__text">Timply dummy text of the printing and typesetting industry. Lorem
                            Ipsum</p>
                    </div><!-- end info-box -->
                </div><!-- end col-lg-3 -->
                <div class="col-lg-4 responsive-column-half">
                    ...
                    <div class="register-content">
                        <div class="section-heading">
                            ...
                            <p class="section__desc">Education is the process of acquiring the body of knowledge and
                                ...
                                process in addition to learning. Bimply dummy text of the printing and typesetting
                                istryrem
                                Ipsum has been the industry’s standard dummy text ever since the 1500s, when an unknown
                                printer Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam aliquid
                                architecto
